...
function TablesForeigns({ columns, data,utype }) {
    ...
    return (
        <>
            <div style={{ display: "flex" }}>
                ...
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded-full" style={{ marginLeft: "auto", }} onClick={() => navigate("./ForeignAdd.js",{state:{utype:utype}})} >Add More</button>
            </div> <br />
