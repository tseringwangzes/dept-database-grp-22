    ...
    return (
        <>
            <div style={{ display: "flex" }}>
                ...
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded-full" style={{ marginLeft: "auto", }} onClick={() => navigate("./FtyAwardAdd.js",{state:{utype:utype}})} >Add More</button>
            </div> <br />
                        ...
                        <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table {...getTableProps()} className="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody {...getTableBodyProps()}
                                    className="bg-white divide-y divide-blue-200"
                                >
                                    {page.map((row, i) => {
                                        prepareRow(row);
                                        if(utype === "1" || utype==='4'){
...
export default FtyTablesAwards;