...
function FtyForeignCsv(){
    ...
    const handleClick=()=>{
      ...
      Papa.parse(file, {
        ...
        columns: [ 'end_date', 'start_date','visit_details', 'country', ],
        ...
        <FtySidebar/>
          <main className="absolute max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
            <div className="">
              ...
              <h1 className="text-xl font-semibold">SELECT A FILE OF GIVEN FORMAT FOR  YOUR FOREIGN VISITS</h1> <br />
        ...
        <Sidebar2/>
          <main className="absolute max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
            <div className="">
              ...
              <h1 className="text-xl font-semibold">SELECT A FILE OF GIVEN FORMAT FOR  FACULTY FOREIGN VISITS</h1> <br />
